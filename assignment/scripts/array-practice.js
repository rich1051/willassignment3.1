...
let foodArray = ['pasta', 'pizza', 'chicken wings', 'mashed potatoes'];
...
console.log('The last animal in the array using array length is', animalArray.length);
...
foodArray.push('breadsticks');
console.log('Added another favorite food to the end:', foodArray);
...
foodArray.unshift('french silk pie');
